...
export const variantStyles = cva("text-black", {
  variants: {
    variant: {
      primary: ``,
      secondary: ``,
...
export const headerStyles: { [key: string]: string } = {
  primary: "bg-primary text-white",
  secondary: "bg-secondary text-white",
  outline: "bg-white text-primary",
};

export const rowStyles: { [key: string]: string } = {
