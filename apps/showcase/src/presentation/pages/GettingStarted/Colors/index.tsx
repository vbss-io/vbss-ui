    ...
    <>
      <S.Container>
        <S.ContentWrapper>
          ...
          <section>
            <S.Paragraph>
              <strong>vbss-ui</strong> allows you to easily customize the color scheme of the components to match your brand or design system.
              By default, the library provides a clean and modern palette, but you can override these values to create a unique look.
            </S.Paragraph>
          </section>
          <section>
            <S.SectionTitle>
            ...
            <S.List>
            <li><P.ColorContainer>Primary <P.Color color="hsl(248 39% 39%)" /></P.ColorContainer></li>
            <li><P.ColorContainer>Secondary <P.Color color="hsl(248 53% 58%)" /></P.ColorContainer></li>
            <li><P.ColorContainer>Highlight <P.Color color="hsl(271 76% 53%)" /></P.ColorContainer></li>
            <li><P.ColorContainer>Text <P.Color color="hsl(0 0% 0%)" /></P.ColorContainer></li>
            <li><P.ColorContainer>Background <P.Color color="hsl(0 0% 100%)" /></P.ColorContainer></li>
            </S.List>
          </section>
          <S.SectionDivider/>
          <section>
            ...
            <S.Paragraph>
              To override these defaults, create a CSS file (e.g. <code>custom-colors.css</code>) and define your custom colors using <strong>HSL format</strong>:
            </S.Paragraph>
          ...
          <section>
            ...
            <S.List>
              ...
              <li>The <strong>HSL format</strong> makes it easy to adjust hue, saturation, and lightness for fine-tuned color control.</li>
            </S.List>
            <S.Paragraph>
